<template>
    <div class="h-full w-full flex items-center justify-between bg-midnightDark px-6">
        ...
        <div class="header-menu flex items-center">
            <div class="search relative hidden lg:inline-flex">
